...
public class search_remove_medicine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                editor.commit();
                Intent show_i1= new Intent(search_remove_medicine.this,show_remove_medicine.class);
    ...
    private void loadIntoListView(String json) throws JSONException {
        ...
        LevelAdapter levelAdapter=new LevelAdapter(search_remove_medicine.this,name,company,company);
