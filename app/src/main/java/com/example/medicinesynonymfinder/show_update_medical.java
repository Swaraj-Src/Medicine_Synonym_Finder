...
public class show_update_medical extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_update_medical);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                //Toast.makeText(show_update_medical.this,""+listView.getItemAtPosition(position).toString(),Toast.LENGTH_LONG).show();
                String item=listView.getItemAtPosition(position).toString();
                SharedPreferences.Editor editor = sharedpreferences.edit();
                editor.putString("id", listView.getItemAtPosition(position).toString());
                editor.commit();
                Intent show_i1= new Intent(show_update_medical.this,update_medical.class);
    ...
    private void loadIntoListView(String json) throws JSONException {
        ...
        LevelAdapter leveladapter=new LevelAdapter(show_update_medical.this,shop_id,shop_name,shop_name);
