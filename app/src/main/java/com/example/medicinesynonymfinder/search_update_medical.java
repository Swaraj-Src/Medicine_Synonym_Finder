...
public class search_update_medical extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_update_medical);
        ...
        remove_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent show_i1 = new Intent(search_update_medical.this, show_update_medical.class);
