...
public class update_profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String id =sharedpreferences.getString("OWNER", "");
    ...
    private class LedOnOff extends AsyncTask<String, Integer, String> {
        ...
        @Override
        protected void onPreExecute() {
            progress = ProgressDialog.show(update_profile.this, null,
                    "Updated Record...");
        ...
        protected void onPostExecute(String result) {
            ...
            progress.dismiss();
            Intent show_i1 = new Intent(update_profile.this, admin.class);
